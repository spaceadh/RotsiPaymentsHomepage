...
export const metadata: Metadata = {
  title: 'REMINDR | FLOW-STATE SYSTEMS',
  description:
    'REMINDR is a flow-state systems case study focused on concentration, output, and cognitive architecture.',
};
...
export default function RemindrPage() {
  return (
    <Layout>
      <header className="fixed left-0 right-0 top-0 z-50 bg-[#f8f9fa] transition-opacity duration-300">
        <div className="mx-auto flex w-full max-w-[1440px] items-center justify-between px-8 py-8 md:px-12">
          <div className="flex items-center gap-4">
            <span className="material-symbols-outlined cursor-pointer text-[#101828] transition-opacity duration-300 hover:opacity-70 active:scale-95">grid_view</span>
            <Link href="/" className="font-headline text-2xl font-bold uppercase tracking-tighter text-[#101828]">
              ROTSI
            </Link>
          </div>
          <div className="flex items-center gap-8">
            <span className="material-symbols-outlined text-[#D4AF37]" style={{ fontVariationSettings: "'FILL' 1" }}>close</span>
          </div>
        </div>
      </header>

      <main className="pt-32">
        <section className="relative flex min-h-[795px] flex-col items-center justify-center overflow-hidden bg-surface px-8 text-center md:px-12">
        ...
        <section className="flex items-center justify-center bg-surface-container-low px-8 py-48 md:px-12">
          <div className="max-w-3xl text-center">
            ...
            <MotionReveal>
              ...
              <p className="font-body text-lg leading-relaxed text-[#45474c]">
                Human potential is tethered by the noise of the digital landscape. Remindr isn&apos;t a tool for management; it is an architectural intervention. By isolating the signal from the noise, we create a sanctuary for deep work.
              </p>
            </MotionReveal>
          </div>
        </section>

        <section className="mx-auto max-w-7xl bg-surface px-8 py-48 md:px-12">
              ...
              <div className="relative z-10 mx-auto flex min-h-[960px] items-center justify-center px-6 py-16 md:min-h-[936px]">
                <div className="relative flex h-[640px] w-[320px] flex-col gap-8 border-[12px] border-primary-container bg-white p-8 shadow-[0_40px_100px_rgba(16,24,40,0.08)]">
                  <div className="flex items-center justify-between">
                    <span className="text-xs font-bold tracking-tighter">REMINDR</span>
        ...
        <section className="bg-primary-container px-8 py-48 text-surface md:px-12">
      ...
      <footer className="w-full border-t border-[#c6c6cd]/10 bg-[#f8f9fa] px-8 py-24 md:px-12">
        <div className="flex flex-col items-center gap-8 text-center">
          ...
          <p className="font-body text-sm uppercase tracking-widest text-[#101828] opacity-40">© 2026 ROTSI SOLUTIONS. REMINDR FLOW-STATE SYSTEM.</p>
        </div>
      </footer>
    </Layout>
  );
