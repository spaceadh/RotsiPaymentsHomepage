...
import { bewamaNavigationItems } from '../../../src/content/navigation';
...
export default function BewamaPage() {
  ...
  const mobileNavigationItems = bewamaNavigationItems();
    ...
    <Layout>
      <header className="fixed top-0 z-50 w-full bg-[#f8f9fa]">
        <div className="mx-auto flex w-full max-w-[1440px] items-center justify-between px-8 py-6 md:px-12">
          ...
          <div className="flex items-center gap-3">
            <span className="material-symbols-outlined hidden cursor-pointer text-[#101828] md:inline-flex">search</span>
      ...
      <footer className="bg-[#f3f4f5] py-20">
        <div className="mx-auto flex w-full max-w-[1440px] flex-col items-center justify-between gap-8 px-8 text-center md:flex-row md:px-12 md:text-left">
          ...
          <div>
            <p className="font-body text-xs uppercase tracking-widest text-[#101828] opacity-60">© {currentYear} BEWAMA INDUSTRIAL INFRASTRUCTURE. ALL RIGHTS RESERVED.</p>
          </div>
        </div>
      </footer>
    </Layout>
