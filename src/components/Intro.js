                        ...
                        <div className="flex-col my-4 text-center lg:text-left lg:my-0 lg:justify-end w-full lg:w-1/2 px-8" data-aos="zoom-in" data-aos-delay="500">
                            ...
                            {/* <div>
                                <p className='my-3 text-l text-gray-600 font-semibold'>
                                    Whether you're an individual seeking to streamline personal finances or a business owner aiming to optimize financial workflows, Rotsi offers an array of tools and resources engineered for success. 
                                    With nominal fees nearly approaching zero percent, we prioritize affordability without compromising quality service. Join us at Rotsi and experience the future of seamless financial management.
                                </p>
                            </div> */}
